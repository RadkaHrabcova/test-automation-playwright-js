...
exports.OrderPage = class OrderPage {
    ...
    this.page = page;
    this.url = '/';
    this.pageHeader = this.page.getByRole('heading', { name: 'Nová objednávka' })
    ...
    this.suburbanCampTab = this.page.getByRole('tab', { name: 'Příměstský tábor' })
    ...
    this.submitButton = this.page.getByRole('button', { name: 'Uložit objednávku' });
    this.thankYouForOrderMessage = this.page.getByRole('heading', { name: 'Děkujeme za objednávku' });
    this.toast = this.page.getByText('×Data z ARESu se nepodařilo')
    //this.toastCloseButton = this.page.getByRole('button', { name: '×' });
